...
## Descripción
Ejecutar checklist de fase: lint, build, tests, mobile, SEO, seguridad y flujos críticos.

## Cuándo usar
Usar cuando la tarea esté relacionada con: ejecutar checklist de fase: lint, build, tests, mobile, seo, seguridad y flujos críticos.
