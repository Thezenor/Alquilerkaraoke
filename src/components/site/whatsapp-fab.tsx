export function WhatsappFab({ url }: { url: string }) {
  return (
    // Oculto en <sm: la barra CTA móvil ya incluye WhatsApp (evita duplicar).
    <a
      href={url}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="WhatsApp"
      className="fixed right-5 bottom-5 z-50 hidden h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 hover:shadow-xl sm:inline-flex"
    >
