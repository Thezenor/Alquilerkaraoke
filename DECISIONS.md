...
- **Diseño premium y conversión (2026-06-10)**:
  ...
  - **"Acceso" (login admin) se mueve del header al footer** (zona legal, discreto) para liberar el header para conversión: teléfono clicable (de `getContact`, no hardcodeado) junto al CTA.
